...
try {
  ...
  const record = {
    ...
    issueId: issue.id,
    type: "observation",
    note: "Restore dry-run verify record.",
    linkedFiles: [],
    linkedCommits: [],
    createdAt: now,
  };
  ...
  const archive = {
    issueId: issue.id,
    projectId: WORKSPACE_ID,
    fileName: "issue-restore-dry-run-0001.md",
    filePath: ".debug_workspace/archive/issue-restore-dry-run-0001.md",
    generatedAt: now,
